    ...
    $.fn.gaugeMeter = function (t) {
        ...
        return this.each(function () {
            ...
            function drawGauge(a) {
                ...
                } else  if (!option.centerZero) {
                  startPoint = -I;
                  endPoint   = P * a - I;
                } else {
                  startPoint = -H;
                  if (!option.antiClockwise) { var endPoint = -H+((H + S)*a); }
                  else { var endPoint = -H-((H + S)*a); }
                }
                ...
                g.stroke();
                g.beginPath();
                g.arc(m, v, x, startPoint, endPoint, option.antiClockwise)
                g.lineWidth = option.markerWidth;
            ...
            } else if(option.startPoint != -1 && option.endPoint != -1) {
              c = -1;
            } else {
